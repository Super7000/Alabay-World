    ...
    return (
        <>
            <div className="w-screen h-screen fixed top-0 left-0 -z-20">
                ...
                <div className="sub-heading flex flex-col justify-center absolute top-1/2 bg-black">
...
function MainPage() {
    return (
        <div className="px-0 md:px-8 z-10 absolute w-full" style={{ top: '90%' }}>
            <div className="w-full bg-white mb-8" style={{ borderRadius: "2rem" }}>
                <Header />
                <Gallery />
                <ProjectVision />
                <RoadMap />
