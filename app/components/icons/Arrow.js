...
function Arrow({ width, className, ...props }) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={width + 'px'} height={width - 9 + 'px'} className={className} {...props} viewBox="0 0 59 52" fill="none">
