...
export default function Games() {
    return (
        <div className="px-4 md:px-12 pb-32 z-20 relative">
            ...
            <p className="mt-0 mb-5 ff-m font-extrabold text-center mx-auto" style={{ fontSize: '4rem' }}>Stay tuned for upcoming games !</p>
            ...
            <h1 className="font-bold text-5xl ff-m"><span className="text-yellow-300">GAME</span> PREVIEW</h1>
            <div className="grid grid-flow-col mt-8">
                <div className="grid grid-flow-col gap-8 overflow-x-auto overflow-y-clip">
                    <div className="rounded-2xl bg-slate-700 overflow-hidden border-8 border-white hover:border-black" style={{ width: '25rem', height: '25rem' }}>
