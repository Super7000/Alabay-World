    ...
    return (
        <div className="md:px-20 pb-32">
            ...
            <div className="flex justify-center items-center flex-col md:flex-row">
                <div className="ff-m rounded-3xl flex flex-col justify-start items-start flex-1 bg-blue-500 border-8 border-blue-800 text-2xl font-bold text-white p-10 gap-6 md:mr-auto shadow-lg shadow-black">
