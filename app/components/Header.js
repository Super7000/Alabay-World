export default function Header() {
    return (
        <div className="w-full h-full">
            {/* bg */}
            <img src="./assets/yellow-bg-1.svg" className="absolute w-full pr-0 sm:pr-16" />
            ...
            <div className="absolute top-40 w-full lg:w-7/12 z-10">
            ...
            <div className="text-center lg:text-right container mr-20 w-full lg:w-5/12 relative z-10 ms-auto h-full mt-24">
