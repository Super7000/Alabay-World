...
function page() {
    return (
        <GamePageLayout
            ...
            themeColor={"#A4A8FF"}
        >
            <div className="scroll-snap scroll-item">
                <p className="text-white ff-m mt-10 w-1/2 font-bold" style={{ fontSize: '1.1rem' }}>Take on the role of the legendary Alabay on a quest to uncover the ancient secrets of its ancestors. </p>
            ...
            <div className='mt-20 scroll-snap scroll-item'>
                <h2 className="text-3xl font-bold mt-auto" style={{ color: "#A4A8FF" }}>FEATURES</h2>
                <div className='text-white mt-4'>
                    <span className='font-semibold ff-m' style={{ fontSize: '1.1rem' }}>
